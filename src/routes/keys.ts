...
const BACKGROUND_REWARD_KEYS = new Set([
  ...
  'cosycafe', 'samurai', 'scholarsdesk', 'ancientrome', 'sakuragarden', 'minimalist', 'premiumgold',
...
const FREE_BACKGROUND_REWARD_KEYS = new Set(['cosycafe', 'diagram-seventies', 'minimalist', 'premiumgold']);
