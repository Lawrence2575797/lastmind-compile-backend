...
router.use('/study-settings', requireAuth, syncEndpointLimiter);

// GET /study-settings -> { dailyMinutesBudget }
router.get('/study-settings', async (req: Request, res: Response) => {
  try {
...
router.post('/study-settings', async (req: Request, res: Response) => {
