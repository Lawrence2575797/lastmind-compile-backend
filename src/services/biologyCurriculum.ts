...
{"atomicConceptId":"the supplied objective.id","explanation":"1-100 words teaching only the objective","taughtPoints":[{"id":"p1","text":"one essential supporting point"}],"practiceQuestion":{"questionText":"Recall the whole taught idea","markScheme":"Require every taught point; list acceptable equivalents","modality":"writing","answerInputType":"words","testedPointIds":["p1"]},"recallChecks":[{"format":"free_text","questionText":"first complete recall prompt","markScheme":"all taught points","testedPointIds":["p1"]},{"format":"free_text","questionText":"second complete recall prompt","markScheme":"all taught points","testedPointIds":["p1"]},{"format":"free_text","questionText":"third complete recall prompt","markScheme":"all taught points","testedPointIds":["p1"]},{"format":"free_text","questionText":"fourth complete recall prompt","markScheme":"all taught points","testedPointIds":["p1"]}]}
