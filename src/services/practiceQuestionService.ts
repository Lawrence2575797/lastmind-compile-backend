...
const MARKING_STRUCTURE_NOTES: Record<string, string> = {
  ...
  'mathematics|gcsefoundation|edexcel': `Edexcel GCSE Mathematics mark schemes award M marks for a valid method, A marks for an accurate result that follows the required method, and B marks for independent facts, statements or conclusions. Working matters: a correct method can earn credit after an arithmetic slip, while an unsupported answer may not earn all available marks. Answers should use exact values, units and stated accuracy where required.`,
  'mathematics|gcsehigher|edexcel': `Edexcel GCSE Mathematics mark schemes award M marks for a valid method, A marks for an accurate result that follows the required method, and B marks for independent facts, statements or conclusions. Working matters: a correct method can earn credit after an arithmetic slip, while an unsupported answer may not earn all available marks. Answers should use exact values, units and stated accuracy where required.`,
};
