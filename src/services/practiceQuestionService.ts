...
// Shared by both GCSE Maths tiers - how Edexcel 1MA1 actually words and
// marks questions. Tier-specific detail is appended where it is used below.
const EDEXCEL_GCSE_MATHS_NOTES = `Edexcel GCSE Mathematics (1MA1) is exam-style: questions are worded exactly as on a real paper, e.g. "Work out...", "Write down...", "Solve...", "Simplify...", "Show that...", "Give a reason for your answer", "Explain why...", "Prove that...". Where a question is set in context, the context is realistic and brief (e.g. "Sam buys...", "The diagram shows..."), and where accuracy matters the question says so ("Give your answer correct to 3 significant figures", "Give your answer in its simplest form", "Give your answer as a fraction"). Multi-mark questions say "You must show all your working" where relevant; do not print mark totals such as "(3)" in the question text. Only include a calculator-style number if the concept genuinely needs one; otherwise use numbers a student can handle without a calculator.
MARKING follows Edexcel mark-scheme conventions: M1 = a correct method (awarded for a valid step even if an arithmetic slip follows), A1 = an accurate result that follows a method (never awarded without its M mark, and cao = correct answer only), B1 = an independent mark for a fact, value or statement needing no method, P1 = a process mark for a step in solving a problem-solving question (typically P1 to start, P1 to complete the process), C1 = a communication mark for a clear, reasoned statement or conclusion. Mark schemes also use: oe (or equivalent), ft (follow through from an earlier error), dep (dependent on a previous mark), isw (ignore subsequent working). A "Show that" question must have method marks for each required step and a final mark for the conclusion, with no credit for merely stating the given answer. Answers with no working can score only if the mark scheme allows it (B marks or a correct final answer for a 1-mark question). Include units and required accuracy in the answer line where the question asks for them.`;
...
const MARKING_STRUCTURE_NOTES: Record<string, string> = {
  ...
  'law|alevel|ocr': `OCR A Level Law (H415) marks every answer against three assessment objectives: AO1 (knowledge and understanding of the English legal system and of legal rules and principles), AO2 (applying those rules and principles to the facts of a scenario to build a legal argument in appropriate legal terminology, supported by cases and statute) and AO3 (analysing and evaluating legal rules, principles, concepts and issues). Every question is levels-based: the whole answer is placed in a band by how well it does what the question asks, not scored as separately-added parts. Question wording follows the OCR command words exactly: 'Explain' or 'Describe' (10 marks, AO1 only - accurate, developed knowledge with correct authority), 'Discuss' (15 marks, AO3 - analysis and evaluation of a legal concept or issue, NO conclusion required), 'Advise' (25 marks - a legal scenario, 10 marks AO1 for the rules and 15 marks AO2 for applying them to the specific facts; the answer identifies the legal issues in the facts, states the rule, applies it to the facts with supporting cases and statute sections, and reaches a conclusion for each party the question names) and 'Discuss the extent to which' (25 marks - an essay, 10 marks AO1 and 15 marks AO3, which MUST reach a supported conclusion). Scenario questions are realistic, brief fact patterns naming fictional people (for example 'Aisha argues with Ben in a car park...'), with enough facts to raise two or three distinct issues and with facts that create genuine arguments on both sides; never quote the mark totals. Credit accurate use of leading cases (with the principle they decide, not just the name) and statutory sections, correct terminology (actus reus, mens rea, ratio decidendi, duty of care), and clear structure. Do not penalise a missing case name if the principle is stated correctly, and do not credit a case or section that is wrongly described.`,
  ...
  'biology|gcse|aqa': `AQA GCSE Biology rewards accurate scientific knowledge (AO1), applying that knowledge to familiar and unfamiliar contexts including practical work (AO2), and analysing or evaluating information and evidence (AO3). Short questions use clear marking points. Six-mark extended responses use a level-based judgement of the answer as a whole: a top-level answer must be scientifically accurate, logically linked, relevant to the context and sufficiently complete. Calculations must show working and use appropriate units where the question requires them.`,
  'chemistry|gcse|aqa': `AQA GCSE Chemistry rewards accurate chemical knowledge (AO1), applying that knowledge to familiar and unfamiliar contexts including practical work (AO2), and analysing or evaluating information and evidence (AO3). Short questions use clear marking points. Six-mark extended responses use a level-based judgement of the answer as a whole: a top-level answer must be scientifically accurate, logically linked, relevant to the context and sufficiently complete. Calculations must show working, chemical equations and appropriate units where required.`,
  'mathematics|gcsefoundation|edexcel': `${EDEXCEL_GCSE_MATHS_NOTES} FOUNDATION TIER: questions run from 1 to 5 marks and use everyday contexts (money, shopping, recipes, journeys, simple shapes, tables and charts). Number, ratio/proportion and basic algebra dominate. Wording is short and direct with numbers kept manageable; the problem-solving questions (4-5 marks) present a real-life scenario and expect the student to choose the steps themselves.`,
  'mathematics|gcsehigher|edexcel': `${EDEXCEL_GCSE_MATHS_NOTES} HIGHER TIER: questions run from 1 to 6 marks. Expect multi-step algebra, surds, quadratics, functions, trigonometry, vectors, circle theorems, probability trees, and algebraic proof ("Prove that..."). Later parts of a paper are unstructured problem-solving with little scaffolding, and "Show that" / proof questions must reach the stated result with every step justified.`,
};
