...
Steps: {"type":"read","term":id,"text":"..."} | {"type":"ask","q":"...","right":"...","wrong":"...","hint":"...","pre":"...","term":id,"diagram":{...optional}} | {"type":"calc","q":"...","answer":<number>,"tol":<optional>,"hint":"...","pre":"...","term":id} (a typed numeric answer - see CALCULATION STEPS above) | {"type":"order","terms":[ids],"prompt":"..."} | {"type":"chains","lanes":[{"label":"Chain 1","terms":[ids]},{"label":"Chain 2","terms":[ids]}],"prompt":"...","then":"what do they lead to?"} | {"type":"recap","terms":[ids],"q":"...","right":"...","wrong":"...","hint":"..."} (use instead of order/chains when the terms genuinely do not build on each other or converge - see rule 6) | {"type":"derive"}
