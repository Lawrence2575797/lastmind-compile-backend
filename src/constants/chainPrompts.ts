...
12. "technique" stays false for every node except a genuine rule-11 case — including the target concept itself, even when it's computed via a technique already captured as its own separate node.
